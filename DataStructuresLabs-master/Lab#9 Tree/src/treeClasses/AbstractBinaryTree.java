...
public abstract class AbstractBinaryTree<E> extends AbstractTree<E> implements
	...
	protected void recDisplay(Position<E> r,//r es una posicion 
			int[] control, int level) 
	{
		...
		Position<E> temp=this.parent(r); // parent devuelve el valor del parametro si esta en el arbol
		
		if( temp==null){
			System.out.println("__ROOT("+r.getElement()+")"); 
		} 
		else if(this.right(temp)== r){
