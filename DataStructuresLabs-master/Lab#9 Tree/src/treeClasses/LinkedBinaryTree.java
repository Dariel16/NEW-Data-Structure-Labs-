...
public class LinkedBinaryTree<E> extends AbstractBinaryTree<E>  {
	...
	private void cloneSubtree(Position<E> rThis, LinkedBinaryTree<E> other, Position<E> rOther) {
		...
		if (this.hasLeft(rThis)) {
			Position<E> tLeft = left(rThis);
			Position<E> pOther = other.addLeft(rOther, tLeft.getElement());
			cloneSubtree(tLeft, other, pOther);
		}
		if (this.hasRight(rThis)) {
			Position<E> tRight = right(rThis);
			Position<E> pOther = other.addRight(rOther, tRight.getElement());
			cloneSubtree(tRight, other, pOther);
		}
